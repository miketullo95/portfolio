...
1. **Discovery & User Research** — Comprehensive research to understand user needs and pain points across the Yale community
2. **Design System Development** — A component-based system that enforced Yale branding while enabling flexibility
3. **Platform Architecture** — New platform structure with centralized components and flexible permissions
4. **Implementation & Rollout** — Shifted to a collaborative development model enabling shared innovation across departments
5. **Feedback & Iteration** — Continuous feedback loops to refine and enhance the platform over time
